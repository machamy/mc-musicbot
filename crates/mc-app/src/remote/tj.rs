...
impl TjChart {
    ...
    pub fn label(self) -> &'static str {
        ...
        match self.str_type {
            // 1 · 8 은 오래 빠져 있었다. TJ 가 숫자의 뜻을 안 알려 줘서 하나씩 곡을 보고
            // 채운 표인데, 그 사이 번호는 있는지조차 몰랐다 (2026-08-16 실제 응답으로 확인).
            1 => "가요",
            8 => "OST",
            2 => "팝송",
            3 => "J-POP",
            ...
            6 => "트로트",
            7 => "인디·어쿠스틱",
            // 9·10·11 은 2026-08-17 에 실제 응답으로 확인했다. 9 는 1·2·3·8 의 상위를
            // 섞은 종합이다(가요와는 100곡 중 27곡만 겹친다).
            9 => "종합",
            10 => "힙합·랩",
            11 => "R&B·소울",
            _ => "기타",
