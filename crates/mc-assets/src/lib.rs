...
async function ").next().unwrap_or(chunk);
  ...
  ")
    ...
    fn version_hash_is_pinned() {
        assert_eq!(version(), "e33bd0008e48a261");
    }
    ...
    fn each_name_returns_its_own_file() {
        let expected: [(&str, &str); 13] = [
            ...
            (
                "portal.css",
                "f1c53d7043cfef3df26926b1044533a275324b6cde715efd661c886defda44f9",
            ),
            (
                "console.css",
            ...
            (
                "portal.js",
                "11e1f27028f022904940bc527c9f93056b0ed6b1bb9d7bd2322c06c9c4eb1dec",
            ),
            (
                "console.js",
